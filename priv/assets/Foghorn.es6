const Foghorn = (function () {
  ...
  ret.onConnectionChange = function (globalConnectionChangeListener) {
      if (typeof globalConnectionChangeListener === 'function') {
  ...
  function disconnect() {
      if (connected()) {
          ...
          pingIntervalId = null
          connectionChangeListener && connectionChangeListener(false, failedConnections)
      }
  }
  ...
  function connect() {
      ...
      websocket.onopen = function (evt) {
          ...
          connectionChangeListener && connectionChangeListener(true, failedConnections)
          failedConnections = 0
